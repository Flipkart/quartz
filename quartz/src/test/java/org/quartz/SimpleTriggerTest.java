...
public class SimpleTriggerTest extends SerializationTestSupport {
    ...
    public void testMisfireInstructionFireNowWithoutReschedule() {
        ...
        SimpleTriggerImpl simpleTrigger = new SimpleTriggerImpl();
        simpleTrigger.setMisfireInstruction(SimpleTrigger.MISFIRE_INSTRUCTION_FIRE_NOW_WITHOUT_RESCHEDULE);
        simpleTrigger.setRepeatCount(5);
        simpleTrigger.setStartTime(startTime.getTime());
        simpleTrigger.setEndTime(endTime.getTime());
        ...
        assertEquals(startTime.getTime(), simpleTrigger.getStartTime());
        assertEquals(endTime.getTime(), simpleTrigger.getEndTime());
        assertNotNull(simpleTrigger.getNextFireTime());
    }
    ...
    public void testMisfireInstructionValidity() throws ParseException {
        ...
        try {
            ...
            trigger.setMisfireInstruction(SimpleTrigger.MISFIRE_INSTRUCTION_FIRE_NOW_WITHOUT_RESCHEDULE);
        }
        catch(Exception e) {
        ...
        try {
            trigger.setMisfireInstruction(SimpleTrigger.MISFIRE_INSTRUCTION_FIRE_NOW_WITHOUT_RESCHEDULE + 1);
